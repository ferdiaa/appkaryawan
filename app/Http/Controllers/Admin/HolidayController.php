...
class HolidayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->session()->flash('success', 'Berhasil Menambahkan Hari Libur');
    ...
    public function update(Request $request, $id)
    {
        ...
        $holiday->save();
        $request->session()->flash('success', 'Berhasil memperbarui Hari Libur');
        return redirect()->route('admin.holidays.index');
    }
    ...
    public function destroy($id)
    {
        $holiday = Holiday::findOrFail($id);
        $holiday->delete();
        request()->session()->flash('success', 'Berhasil Menghapus Hari Libur');
        return back();
    }
}

...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List Izin</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    ...
                    @error('status')
                        <div class="alert alert-danger">
                            Pilih pilihan yang disediakan
                        </div>
                    @enderror
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">List Izin</h3>
                        </div>
                        <div class="card-body">
                            @if ($leaves->count())
                            <table class="table table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="none">Tanggal Berakhir</th>
                                    ...
                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="card card-info">
                                                <div class="card-header">
                                                    <h5 style="text-align: center !important">Ubah Status Izin</h5>
                                                </div>
                                                <form 
                                                ...
                                                <div class="card-footer text-center">
                                                    <button type="submit" class="btn flat btn-info">Perbarui</button>
                                                </div>
                                            </form>
                                            </div>
                                        </div>

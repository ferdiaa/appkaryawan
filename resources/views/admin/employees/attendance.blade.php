            ...
            <div class="col-md-4 mx-auto">
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="text-center">Cari berdasarkan tanggal</h5>
                    </div>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="card-title text-center">
                            @if ($date)
                            Kehadiran Karyawan pada tanggal {{ $date }}                                
                            @else
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama</th>
                                    <th>Masuk</th>
                                    <th class="none">Catatan Masuk</th>
                                    <th>Keluar</th>
                                    <th class="none">Catatan Keluar</th>
                                    <th>Departemen</th>
                                    <th>Posisi</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($employee->attendanceToday)
                                        <td><h6 class="text-center"><span class="badge badge-pill badge-success">Tersimpan</span></h6></td>
                                        <td>
                                        ...
                                        @if ($employee->attendanceToday->exit_ip)
                                            <td><h6 class="text-center"><span class="badge badge-pill badge-success">Tersimpan</span></h6></td>
                                            <td>
                                                Tercatat Pada {{ $employee->attendanceToday->updated_at->format('H:i:s') }} from {{ $employee->attendanceToday->exit_location}} with IP {{ $employee->attendanceToday->exit_ip}}
                                            </td>
                                        @else
                                            <td><h6 class="text-center"><span class="badge badge-pill badge-danger">Tidak ada Catatan</span></h6></td>
                                            <td><h6 class="text-center"><span class="badge badge-pill badge-danger">Tidak ada Catatan</span></h6></td>
                                        @endif
                                    @else
                                        <td><h6 class="text-center"><span class="badge badge-pill badge-danger">Tidak ada Catatan</span></h6></td>
                                    ...
                                    <td>
                                        ...
                                        >Hapus Catatan Kehadiran</button>
                                        @else 
                                        Tidak ada aksi
                                        @endif
                                    </td>
                                    ...
                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="card card-danger">
                                                <div class="card-header">
                                                    <h5 style="text-align: center !important">Anda Yakin?</h5>
                                                </div>
                        ...
                        <div class="alert alert-info text-center" style="width:50%; margin: 0 auto">
                            <h4>Tidak ada catatan kehadiran ditemukan</h4>
                        </div>
                        @endif

...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List Kehadiran</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-3 mx-auto">
                    <div class="card">
                        <div class="card-header">
                                <h5 class="text-center text-primary" style="text-align: center !important">Cari kehadiran berdasarkan range tanggal</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <table class="table table-bordered table-hover" id="dataTable">
                                ...
                                @foreach($attendances as $index => $attendance)
                                    <tr>
                                        ...
                                        <td class="text-center">Tidak ada catatan</td>
                                        <td class="text-center">Tidak ada catatan</td>
                                        <td class="text-center">Tidak ada catatan</td>
                                        <td class="text-center">Tidak ada catatan</td>

...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Isi Kehadiran</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                        ...
                        @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="entry_time">Jam Masuk</label>
                                            <input
                                            type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="entry_location">Lokasi</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            id="entry_loc"
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exit_time">Jam Keluar</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            name="exit_time"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exit_location">Lokasi</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            id="exit_loc"
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exit_location">Jam Keluar</label>
                                            <input
                                            type="text"
                                            class="form-control text-center"
                                            name="exit_location"

...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List alasan terlambat</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">List alasan terlambat</h3>
                        </div>
                        <div class="card-body">
                            @if ($expenses->count())
                                    ...
                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="card card-danger">
                                                <div class="card-header">
                                                    <h5 style="text-align: center !important">yakin untuk menghapus?</h5>
                                                </div>
